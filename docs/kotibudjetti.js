...
;(() => {
  ...
  var FI = {
    ...
    storage: {
      ...
      actions: {
        ...
        showExample: 'N\xE4yt\xE4 esimerkki',
  ...
  function applyCashDistributions(
    ...
    return [...entries]
      ...
      .map((entry) => {
        ...
        const isAfterIpoDate = !!(
          ipoDate &&
          cashDistributionDate &&
          cashDistributionDate.getTime() >= ipoDate.getTime()
        )
        ...
        const eightPercentYieldLimit = shareholderMathematicalValue.mul(
          rules.unlistedDividend.mathematicalValueYieldRate
        )
        ...
        const taxableCapitalIncome = isAfterIpoDate
          ? dividendTotal.mul(rules.listedDividend.taxableCapitalIncomeRate)
          : lowCapitalPart
        ...
        const taxFreeCapitalIncomePortion = isAfterIpoDate
          ? dividendTotal.mul(rules.listedDividend.taxFreeCapitalIncomeRate)
          : lowCapitalPart
        ...
        const taxableEarnedDividend = isAfterIpoDate
          ? zero
          : earnedDividendGross.mul(rules.unlistedDividend.earnedDividendTaxableRate)
        const taxFreeEarnedDividend = isAfterIpoDate
          ? zero
          : earnedDividendGross.mul(rules.unlistedDividend.earnedDividendTaxFreeRate)
        ...
        const withholdingToTaxOffice = isAfterIpoDate
          ? dividendTotal.mul(rules.listedDividend.withholdingRate)
          : lowWithholdingPart
  ...
  function calculateSellSummary(
    ...
    for (const lot of sellableLots) {
      ...
      const hankintamenoOlettaRate = isAtLeastYears(
        ...
        ? new decimal_default(rules.hankintamenoOlettama.longOwnershipRate)
        : new decimal_default(rules.hankintamenoOlettama.shortOwnershipRate)
  ...
  function createOsakkeetFormData(demo) {
    return {
      ...
      mathematicalShareValues: demo
        ? [
            { id: createId2('math'), year: '2022', valuePerShare: '28.50' },
            { id: createId2('math'), year: '2023', valuePerShare: '33.00' },
            { id: createId2('math'), year: '2024', valuePerShare: '39.00' },
            { id: createId2('math'), year: '2025', valuePerShare: '47.00' },
            { id: createId2('math'), year: '2026', valuePerShare: '54.55' },
          ]
  ...
  function sanitizeOsakkeetFormData(data2) {
    ...
    return {
      ...
      sell: {
        ...
        otherAnnualCapitalGainsOrLosses:
          ((_b = data2.sell) == null ? void 0 : _b.otherAnnualCapitalGainsOrLosses) || '',
      },
    }
  }
  ...
  function createResultsSection(dataState) {
    ...
    return {
      ...
      set({ osakkeetCalculation, texts }) {
        ...
        setTextValue(
          annualAdjustmentInputHelpNode,
          texts.summary.ipoSell.cashReserve.otherAnnualCapitalGainsOrLossesHelp
        )
        replaceChildren(
          warningRoot,
        ...
        replaceChildren(
          ...
          infoCard(
            ...
            texts.summary.ipoSell.cashReserve.taxEffectFromOtherAnnualCapitalHelp(
              ...
              euro(
                decimal_default.max(
                  osakkeetCalculation.sell.annualTaxChange,
                  osakkeetCalculation.sell.grossTotal.mul(0)
                )
              )
            )
          )
  ...
  function osakkeetIpoCalculatorPage() {
    ...
    dataState.onValueChange((data2) => {
      tryStorageSet(sessionStorage, storageKeys.windowFormData, serializeOsakkeetFormData(data2))
    })
